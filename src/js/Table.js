...
export default class Table {
  constructor() {
    ...
    this.db = json;
    this.sort = [
      { sortDirection: "up", sortItem: "id" },
      { sortDirection: "down", sortItem: "id" },
      { sortDirection: "up", sortItem: "title" },
      { sortDirection: "down", sortItem: "title" },
      { sortDirection: "up", sortItem: "imdb" },
      { sortDirection: "down", sortItem: "imdb" },
      { sortDirection: "up", sortItem: "year" },
      { sortDirection: "down", sortItem: "year" },
    ];
  }
  ...
  sorted(options) {
    ...
    if (options.sortDirection === "up") {
      ...
      const findedHeader = [...tableHeaders].find(
        (el) => el.textContent === options.sortItem
      );
